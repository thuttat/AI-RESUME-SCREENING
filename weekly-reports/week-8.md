...
| :--- | :--- | :--- | :--- |
| **Trịnh Thị Anh Thư** | 2351010205 | Viết tài liệu hướng dẫn sử dụng (User Manual) và tổng hợp file báo cáo cuối kỳ. Kiểm tra lại luồng đánh giá của Manager.| [e](https://github.com/thuttat/AI-RESUME-SCREENING/commit/6ed376bddd712e6b56c3ed7f29e4f7bcccf60022) |
| **Lê Hoàng Bảo Trân** | 2351010214 |Kiểm thử hiệu năng (Stress test) khi upload file PDF dung lượng lớn. Tối ưu hóa giao diện mobile/responsive cho các bảng dữ liệu, test role recruiter| [e](https://github.com/thuttat/AI-RESUME-SCREENING/commit/c9ec609bb6b30acc2ee658ceb87018ce5eb3fbee) |
| **Nguyễn Triệu Duy** | 2351010036 | Đóng gói ứng dụng bằng **Docker** (Dockerfile cho Spring Boot và React). Thiết lập Docker Compose để chạy đồng bộ MySQL, RabbitMQ và Application, test role admin| [e](https://github.com/thuttat/AI-RESUME-SCREENING/commit/e1aaf6aff4de47ff3b8b7333d799ebb304989703) |
...
## 3. Kế hoạch tuần tới (Tuần 9 - Finalization & Deployment)

| Thành viên | Công việc dự kiến                                |
| :--- |:--------------------------------------------------|
| **Trịnh Thị Anh Thư** | hoàn thiện unit test các chức năng của Manager.   |
| **Lê Hoàng Bảo Trân** | hoàn thiện unit test các chức năng của Recruiter. |
| **Nguyễn Triệu Duy** | hoàn thiện unit test các chức năng của Admin.     |
...
---
*Ngày nộp: 27/04/2026* *Xác nhận của Nhóm trưởng: Trịnh Thị Anh Thư*